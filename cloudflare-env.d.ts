/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 3bf24199e430d09b7ef298462c1e2a42)
// Runtime types generated with workerd@1.20260710.1 2026-07-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	API_BASE_URL: "https://api.valydejersey.com";
	NEXT_PUBLIC_SITE_URL: "https://valydejersey.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_BASE_URL" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_MIDTRANS_ENV" | "NEXT_PUBLIC_MIDTRANS_CLIENT_KEY" | "NEXTJS_ENV">> {}
}
