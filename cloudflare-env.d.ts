/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: ec8ce62714132cd83b0fabc3e173282e)
// Runtime types generated with workerd@1.20260722.1 2026-07-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	WORKER_SELF_REFERENCE: Fetcher /* f1-cust-fe-staging */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace<import("./.open-next/worker").DOQueueHandler>;
		NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace<import("./.open-next/worker").DOShardedTagCache>;
		WORKER_SELF_REFERENCE: Fetcher /* f1-cust-fe-staging */;
	}
