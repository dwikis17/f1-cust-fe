...
export default async function CollectionPage({ params, searchParams }: CollectionPageProps) {
	...
	return <main className="page-shell collection-page">
		...
		{galleryCollections
			? <CollectionGallery id={response.collection.slug} title={galleryTitle} collections={galleryCollections} locale={locale} priority showTitle={false} messages={messages} />
